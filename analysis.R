...
ggplot(data_wide) +
  ...
  labs(title = "Life Expectancy Differerce vs HALE Difference",
...
cor(data_wide$le_diff, data_wide$hale_diff)

# answer to question

# From the charts created in this file, we can understand that life expectancy
# and health adjusted life expectancy has a strong, positive correlation of 
# 0.996 which shows that the higher the life expectancy, the healthier lives
# people will live.